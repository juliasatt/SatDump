...
namespace satdump
{
    ...
    {
        /**
         * @brief This block is intended to be used
         * in cases where a greater level of control
         * over certain parameters is needed
         */

        /** @brief The block is pretty on par
         * with the FFT Pan block.
         * @see FFTPanBlock
         */

        // TODOREWORK(?) could be expanded and/or improved in some ways
        ...
        public:
             ...
             * @param fft_overlap FFT Overlap
             * @param block_size Input Block Size
             */
